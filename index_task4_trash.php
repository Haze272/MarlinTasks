                        ...
                        <div class="panel-content">
                            ...
                            $array = [
                                [
                                    'title' => 'My Tasks',
                                    "progress" => '130 / 500',
                                    'bg_attribute' => 'bg-fusion-400',
                                    'valuenow' => '65',
                                ],
                                [
                                    'title' => 'Transfered',
                                    'progress' => '440 TB',
                                    'bg_attribute' => 'bg-success-500',
                                    'valuenow' => '34',
                                ],
                                [
                                    'title' => 'Bugs Squashed',
                                    'progress' => '77%',
                                    'bg_attribute' => 'bg-info-400',
                                    'valuenow' => '77',
                                ],
                                [
                                    'title' => 'User Testing',
                                    'progress' => '7 days',
                                    'bg_attribute' => 'bg-primary-300',
                                    'valuenow' => '84',
                                ],
                            ];
                            ...
                            foreach($array as $key => $value)
                                ...
                                echo $value['title'];
                                echo '<span class="d-inline-block ml-auto">' . $value['progress'] . '</span></div>';
                                if ($i != count($array)){
                                    echo '<div class="progress progress-sm mb-3">';
                                    $i++;
                                } else {
                                    echo '<div class="progress progress-sm mb-g">';
                                }
